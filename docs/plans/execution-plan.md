...
|---|---|---|---|
| M5.1 | FragMap panel shell only (Primary/Advanced sections, canonical labels/colors, default all-hidden state). No runtime map load/toggle wiring. | M4B | Prompt A/B complete for M5.1 with no M1-M4B regressions. |
