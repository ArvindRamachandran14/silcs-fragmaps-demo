...
- M5 sliced-preview exception (locked for this project):
  - M5 is delivered in eight slices (`M5.1`, `M5.2`, `M5.2a`, `M5.2b`, `M5.3`, `M5.4`, `M5.5`, `M5.6`) and uses per-slice design gates.
