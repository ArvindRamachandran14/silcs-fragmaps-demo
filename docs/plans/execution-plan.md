...
| M5.3 | Advanced rows + Exclusion Map fixed behavior (visibility-toggleable, fixed style, no editable iso). | M5.2 | Advanced rows and exclusion behavior match spec without regressing M5.2. |
